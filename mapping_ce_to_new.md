...
| data1 | [simpl-files](https://code.europa.eu/simpl/simpl-open/development/data1/simpl-files) | [`governance/contract-management/contract-establishment/contract-template-datastore`](./governance/contract-management/contract-establishment/contract-template-datastore) | placed | ❌ |
...
| Gaia-X-EDC | EDC MinIO s3 | — | pending | ⚠️ |
...
| Gaia-X-EDC | simpl-signer | — | pending | ⚠️ |
...
| IAA | echo backend | — | pending | Under samples, need canonical info|
| IAA | echo frontend | — | pending | Under samples, need canonical info|
| IAA | eIDAS demo keycloack extension | — | pending | Under samples, need canonical info|
| IAA | eIDAS Demo Node deploy | — | pending | Under samples, need canonical info|
...
| IAA | microfrontend framework | — | pending | Under samples, need canonical info |
...
| Monitoring | eck-monitoring-operator | — | pending | ⚠️ |
...
| Monitoring | monitoring-proxy | — | pending | ⚠️ |
| Monitoring | monitoring-reporting-fe | — | pending | ⚠️ |
...
| orchestration-platform | asset-orchestrator | — | pending | ⚠️ |
