...
- [Contract Manager](../../../../contract-management/contract-lifecycle-management/contract-manager/doc/architecture.md) — accesses policy templates during contract establishment to anchor agreed policies to contracts.
