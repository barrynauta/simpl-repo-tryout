...
|------|------|-------|---------|------|
| [`asyncapi-v1.yaml`](asyncapi-v1.yaml) | asyncapi | Users and Roles Async API | `1.3.0` | 7 KB |
| [`usersroles-tier1-v2.yaml`](usersroles-tier1-v2.yaml) | openapi | User and Roles Tier 1 | `2.0.0` | 100 KB |
| [`usersroles-v1.yaml`](usersroles-v1.yaml) | openapi | User and Roles | `1.5.0` | 40 KB |
