...
<a href="../README.md">users-roles</a> &nbsp;»&nbsp;
<strong>API specifications</strong>
</p>
</div>

# API specifications — users-roles
...
|------|----------|------|-------|---------|------|
| [`asyncapi-v1.yaml`](asyncapi-v1.yaml) | [📖 view](asyncapi-v1.html) | asyncapi | Users and Roles Async API | `1.3.0` | 7 KB |
| [`usersroles-tier1-v2.yaml`](usersroles-tier1-v2.yaml) | [📖 view](usersroles-tier1-v2.html) | openapi | User and Roles Tier 1 | `2.0.0` | 100 KB |
| [`usersroles-v1.yaml`](usersroles-v1.yaml) | [📖 view](usersroles-v1.html) | openapi | User and Roles | `1.5.0` | 40 KB |
