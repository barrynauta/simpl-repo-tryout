...
The Simpl-Open welcome page helps you understand the first steps you need to take to register in a dataspace. It provides simple instructions and a button that allows you to navigate to the [registration](#2-registration-page) page.
...
The page can be accessed via the following link `<authority-frontend>/onboarding/application/request`.
...
To continue, click the button (Create credentials)

![](./imgs/onboarding/onboarding-applicant/registration%20page.png)
...
(i.e., a user with the **APPLICANT** role, use the user you registered in 2. [step two](#2-registration-page)
)
