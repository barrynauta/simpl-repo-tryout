...
<a href="../README.md">contract-manager</a> &nbsp;»&nbsp;
<strong>API specifications</strong>
</p>
</div>

# API specifications — contract-manager
...
|------|----------|------|-------|---------|------|
| [`openapi3-v1.yaml`](openapi3-v1.yaml) | [📖 view](openapi3-v1.html) | openapi | Contract Manager | `1.1` | 37 KB |
