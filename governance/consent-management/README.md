...
<a href="../../README.md">🏠 Home</a><br/>
    <a href="../README.md">Dimension: Governance</a><br/>
        <strong>Capability: Consent management</strong><br/>
</p>
</div>
...
Ensures that data subjects' consent preferences are properly captured, managed, and respected throughout data processing activities.
