...
<a href="../../../README.md">🏠 Home</a><br/>
    <a href="../../README.md">Foundations</a><br/>
        <a href="../README.md">DevSecOps</a><br/>
            <strong>Trivy (image scanning / SBOM)</strong><br/>
</p>
</div>

# Trivy (image scanning / SBOM)

> Stub README created to anchor the [Solution → Service mapping](../../../MAPPING.md) (row 115). FTA reference: §8.7.3 CI/CD Pipeline.
>
