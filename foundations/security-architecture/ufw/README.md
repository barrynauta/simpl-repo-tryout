...
<a href="../../../README.md">🏠 Home</a><br/>
    <a href="../../README.md">Foundations</a><br/>
        <a href="../README.md">Security architecture</a><br/>
            <strong>UFW (Uncomplicated Firewall)</strong><br/>
</p>
</div>

# UFW (Uncomplicated Firewall)

> Stub README created to anchor the [Solution → Service mapping](../../../MAPPING.md) (row 79). FTA reference: §6.3.1 Technology Roadmap.
>
