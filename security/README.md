...
    <strong>Dimension: Security</strong><br/>
</p>
</div>

# Security

Identity, authentication, authorisation, and credential management services for the Simpl-Open data space. Implements a two-tier IAA architecture (Tier 1: participant-internal RBAC; Tier 2: cross-participant ABAC via mTLS).
