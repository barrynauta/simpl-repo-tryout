...
- [Onboarding](../../../../../governance/participant-management/onboarding/onboarding/doc/architecture.md) — calls Identity Provider to trigger Tier 2 credential creation upon approval of an onboarding request; also calls it for credential lifecycle actions (SA 03).
