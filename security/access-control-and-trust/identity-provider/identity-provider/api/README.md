...
|------|------|-------|---------|------|
| [`identityprovider-tier1-v2.yaml`](identityprovider-tier1-v2.yaml) | openapi | Identity Provider Tier 1 | `2.0.0` | 129 KB |
| [`identityprovider-tier2-v2.yaml`](identityprovider-tier2-v2.yaml) | openapi | Identity Provider Tier 2 | `2.0.0` | 51 KB |
| [`identityprovider-v1.yaml`](identityprovider-v1.yaml) | openapi | Identity Provider | `1.5.0` | 50 KB |
