...
|------|------|-------|---------|------|
| [`securityattributesprovider-tier1-v2.yaml`](securityattributesprovider-tier1-v2.yaml) | openapi | Security Attributes Provider Tier 1 | `2.0.0` | 36 KB |
| [`securityattributesprovider-tier2-v2.yaml`](securityattributesprovider-tier2-v2.yaml) | openapi | Security Attributes Provider Tier 2 | `2.0.0` | 20 KB |
| [`securityattributesprovider-v1.yaml`](securityattributesprovider-v1.yaml) | openapi | Security Attributes Provider | `1.5.0` | 46 KB |
