## Security attribute provider Frontend

### Install on Kubernetes
```shell
helm repo add fe-security-attribute-provider-charts https://code.europa.eu/api/v4/projects/1309/packages/helm/stable
helm install fe-security-attribute-provider fe-security-attribute-provider-charts/fe-security-attribute-provider \
--version <chart version> \
--values values.yaml
```

> **💡** The latest chart version can be found in the releases section of the project's repository. Please note that hotfixes may have been released since the last major update. Hotfixes may have been released. [Link to releases](https://code.europa.eu/simpl/simpl-open/development/iaa/fe-security-attribute-provider/-/releases).
...
cors: # this is an example, update this field
  allowOrigin: https://t1.<agent-namespace>.dev.simpl-europe.eu,https://security-attribute-provider.<agent-namespace>.fe.dev.simpl-europe.eu,http://localhost:4202,http://localhost:4203,http://localhost:3000
ingress:
  issuer: dev-prod
