...
|------|----------|------|-------|---------|------|
| [`asyncapi-v1.yaml`](asyncapi-v1.yaml) | [📖 view](asyncapi-v1.html) | asyncapi | Tier 2 Gateway Async API | `1.3.0` | 2 KB |
| [`tier1gateway-v1.yaml`](tier1gateway-v1.yaml) | [📖 view](tier1gateway-v1.html) | openapi | Tier 1 Gateway | `1.5.0` | 2 KB |
