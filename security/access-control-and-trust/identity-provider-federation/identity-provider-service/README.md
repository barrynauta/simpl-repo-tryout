    ...
    <a href="../../../README.md">Dimension: Security</a><br/>
        <a href="../../README.md">Capability: Access control and trust</a><br/>
            <a href="../README.md">Service: Identity provider</a><br/>
                <strong>Identity Provider (custom service)</strong><br/>
</p>
</div>

# Identity Provider (custom service)

> Stub README. FTA references: §4.2.1 ACV Static - Identity Provider Service, §6.1.1.
>
