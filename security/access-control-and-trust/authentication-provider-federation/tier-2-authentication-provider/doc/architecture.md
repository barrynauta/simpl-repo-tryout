...
- [Authorisation](../../../authorisation/README.md) — the Tier 2 ABAC gateway uses the Tier 2 Authentication Provider to validate Tier 2 credentials and retrieve identity attributes for authorisation decisions in agent-to-agent communication.
