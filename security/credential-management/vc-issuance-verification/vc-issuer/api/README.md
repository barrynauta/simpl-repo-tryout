...
<a href="../README.md">vc-issuer</a> &nbsp;»&nbsp;
<strong>API specifications</strong>
</p>
</div>

# API specifications — vc-issuer
...
|------|----------|------|-------|---------|------|
| [`openapi3-v1.yaml`](openapi3-v1.yaml) | [📖 view](openapi3-v1.html) | openapi | Verifiable Credentials issuer service | `1.1` | 20 KB |
