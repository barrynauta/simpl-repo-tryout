...
<a href="../../README.md">🏠 Home</a><br/>
    <a href="../README.md">Dimension: Integration</a><br/>
        <strong>Capability: Supporting integration services</strong><br/>
</p>
</div>
...
Maintains persistent resource addresses across federated environments and integration endpoints.
