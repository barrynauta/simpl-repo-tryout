...
|------|------|-------|---------|------|
| [`openapi-edc-connector-adapter-v1.yaml`](openapi-edc-connector-adapter-v1.yaml) | openapi | EDC Connector Adapter API | `1.0` | 31 KB |
| [`openapi-edc-connector-adapter-v2.yaml`](openapi-edc-connector-adapter-v2.yaml) | openapi | EDC Connector Adapter API | `1.0` | 8 KB |
