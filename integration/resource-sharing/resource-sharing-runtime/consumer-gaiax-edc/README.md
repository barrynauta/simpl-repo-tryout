    ...
    <a href="../../../README.md">Dimension: Integration</a><br/>
        <a href="../../README.md">Capability: Resource sharing</a><br/>
            <a href="../README.md">Service: Resource sharing runtime</a><br/>
                <strong>Solution: consumer-gaiax-edc</strong><br/>
</p>
</div>

# consumer-gaiax-edc

Consumer-side deployment variant of the Gaia-X EDC connector — packaging tailored for the consumer participant node.
...
> Folder name `consumer-gaiax-edc`; upstream gitlab repo is `gaia-x-edc/consumer-gaia-x-edc`.
