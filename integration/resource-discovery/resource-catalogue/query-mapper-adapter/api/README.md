...
<a href="../README.md">query-mapper-adapter</a> &nbsp;»&nbsp;
<strong>API specifications</strong>
</p>
</div>

# API specifications — query-mapper-adapter
...
|------|----------|------|-------|---------|------|
| [`adapter_openapi.yaml`](adapter_openapi.yaml) | [📖 view](adapter_openapi.html) | openapi | Query Mapper Adapter API | `1.0.0` | 33 KB |
