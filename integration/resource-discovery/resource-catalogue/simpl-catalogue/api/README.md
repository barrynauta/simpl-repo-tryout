...
<a href="../README.md">simpl-catalogue</a> &nbsp;»&nbsp;
<strong>API specifications</strong>
</p>
</div>

# API specifications — simpl-catalogue
...
|------|----------|------|-------|---------|------|
| [`fc_openapi-itb.yaml`](fc_openapi-itb.yaml) | [📖 view](fc_openapi-itb.html) | openapi | Eclipse XFSC Federated Catalogue | `1.0.0` | 108 KB |
| [`fc_openapi.yaml`](fc_openapi.yaml) | [📖 view](fc_openapi.html) | openapi | Eclipse XFSC Federated Catalogue | `1.0.0` | 61 KB |
