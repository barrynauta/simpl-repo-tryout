...
|------|------|-------|---------|------|
| [`fc_openapi-itb.yaml`](fc_openapi-itb.yaml) | openapi | Eclipse XFSC Federated Catalogue | `1.0.0` | 108 KB |
| [`fc_openapi.yaml`](fc_openapi.yaml) | openapi | Eclipse XFSC Federated Catalogue | `1.0.0` | 61 KB |
