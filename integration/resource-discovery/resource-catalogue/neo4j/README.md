    ...
    <a href="../../../README.md">Dimension: Integration</a><br/>
        <a href="../../README.md">Capability: Resource discovery</a><br/>
            <a href="../README.md">Service: Resource catalogue</a><br/>
                <strong>Neo4j (Graph Database for catalogue)</strong><br/>
</p>
</div>

# Neo4j (Graph Database for catalogue)

> Stub README created to anchor [MAPPING.md](../../../../MAPPING.md) row 5. FTA references: §6.1.2, §6.3.2, §6.5 Federated Catalogue / Graph database.
>
