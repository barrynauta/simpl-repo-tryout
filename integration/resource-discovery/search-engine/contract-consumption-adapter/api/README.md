...
<a href="../README.md">contract-consumption-adapter</a> &nbsp;»&nbsp;
<strong>API specifications</strong>
</p>
</div>

# API specifications — contract-consumption-adapter
...
|------|----------|------|-------|---------|------|
| [`openapi-contract-consumption-be-tier1-v1.yaml`](openapi-contract-consumption-be-tier1-v1.yaml) | [📖 view](openapi-contract-consumption-be-tier1-v1.html) | openapi | Contract Consumption API | `1.0` | 29 KB |
