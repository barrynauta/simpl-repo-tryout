...
<a href="../README.md">validation-backend</a> &nbsp;»&nbsp;
<strong>API specifications</strong>
</p>
</div>

# API specifications — validation-backend
...
|------|----------|------|-------|---------|------|
| [`openapi-validation-v1.yaml`](openapi-validation-v1.yaml) | [📖 view](openapi-validation-v1.html) | openapi | Validation Service API | `1.0` | 10 KB |
