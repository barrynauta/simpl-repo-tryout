...
|------|----------|------|-------|---------|------|
| [`openapi-schema-sync-adapter-tier2-v1.yaml`](openapi-schema-sync-adapter-tier2-v1.yaml) | [📖 view](openapi-schema-sync-adapter-tier2-v1.html) | openapi | Schema Sync Adapter API | `1.0` | 9 KB |
| [`openapi-schema-sync-adapter-v1.yaml`](openapi-schema-sync-adapter-v1.yaml) | [📖 view](openapi-schema-sync-adapter-v1.html) | openapi | Schema Sync Adapter API | `1.0` | 9 KB |
