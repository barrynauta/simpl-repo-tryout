...
<a href="../README.md">deployment-script-and-template-management</a> &nbsp;»&nbsp;
<strong>API specifications</strong>
</p>
</div>

# API specifications — deployment-script-and-template-management
...
|------|----------|------|-------|---------|------|
| [`infrastructure-provisioning-api.yaml`](infrastructure-provisioning-api.yaml) | [📖 view](infrastructure-provisioning-api.html) | openapi | Infrastructure Provisioning OpenApi | `1.9.0` | 182 KB |
