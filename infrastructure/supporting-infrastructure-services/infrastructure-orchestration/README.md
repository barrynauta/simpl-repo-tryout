...
<a href="../../../README.md">🏠 Home</a><br/>
    <a href="../../README.md">Dimension: Infrastructure</a><br/>
        <a href="../README.md">Capability: Supporting infrastructure services</a><br/>
            <strong>Service: Infrastructure orchestration</strong><br/>
</p>
</div>

# Infrastructure orchestration

Automates declarative deployment and day-2 operations of infrastructure resources. Currently realised by Argo CD (deployment) and the Argo Workflows / Argo Events stack; Kubernetes is the platform; OKD/OpenShift is a candidate for the orchestrator runtime.
