...
Capability-map placement: `integration / resource-discovery / search-engine / query-mapper-adapter`. Sits beside the [Catalogue Client Application](../catalogue-client-application/README.md) within the same business service; it bridges queries into the [Simpl Catalogue](../../resource-catalogue/simpl-catalogue/README.md).
...
- Query translation between EDC asset queries and the [Simpl Catalogue](../../resource-catalogue/simpl-catalogue/README.md) API.
...
- **Federated Catalogue** — `gaia-x-edc/simpl-fc-service` (the [Simpl Catalogue](../../resource-catalogue/simpl-catalogue/README.md)) — the registration and query target.
