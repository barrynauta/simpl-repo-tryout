    ...
    <a href="../../../README.md">Cross-Cutting</a><br/>
        <a href="../../README.md">Agents</a><br/>
            <a href="../README.md">Agent resource-handling</a><br/>
                <strong>consumer-resource-handling</strong><br/>
</p>
</div>

# consumer-resource-handling

Consumer-side deployment composition (umbrella Helm/ArgoCD chart) for the resource-handling slice of a Simpl-Open agent. Consumed by the [consumer-agent](../../consumer-agent/README.md) master chart.
