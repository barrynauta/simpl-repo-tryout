...
<a href="../README.md">notification-service</a> &nbsp;»&nbsp;
<strong>API specifications</strong>
</p>
</div>

# API specifications — notification-service
...
|------|----------|------|-------|---------|------|
| [`asyncapi-v1.yaml`](asyncapi-v1.yaml) | [📖 view](asyncapi-v1.html) | asyncapi | Notification Service API | `1.0.0` | 2 KB |
| [`asyncapi.yaml`](asyncapi.yaml) | [📖 view](asyncapi.html) | asyncapi | Notification Service API | `1.0.0` | 1 KB |
