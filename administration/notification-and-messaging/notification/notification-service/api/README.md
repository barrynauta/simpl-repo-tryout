...
|------|------|-------|---------|------|
| [`asyncapi-v1.yaml`](asyncapi-v1.yaml) | asyncapi | Notification Service API | `1.0.0` | 2 KB |
| [`asyncapi.yaml`](asyncapi.yaml) | asyncapi | Notification Service API | `1.0.0` | 1 KB |
